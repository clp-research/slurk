...
def token():
    form = TokenGenerationForm(
        ...
        user_log_query=_boolean_parameter("user_log_query"),
        ...
        room_log_query=_boolean_parameter("room_log_query"),
        room_create=_boolean_parameter("room_create"),
        room_update=_boolean_parameter("room_update"),
    ...
    tokens = [Token(source=form.source.data,
                    ...
                    permissions=Permissions(
                        ...
                        user_log_query=form.user_log_query.data,
                        ...
                        room_log_query=form.room_log_query.data,
                        room_create=form.room_create.data,
                        room_update=form.room_update.data,
